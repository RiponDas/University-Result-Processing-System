`<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="images/Ripon.jpg" alt="Ripon das" class="img-circle profile-img">
                                <h6 class="title">Ripon das</h6>
                                ...
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="nav-header">
									  ...
									  <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="create-dept.php"><i class="fa fa-bars"></i> <span>Add Department</span></a></li>
									 ...
									 <li class="has-children">
                                        ...
                                        <ul class="child-nav">
                                            <li><a href="create-subject.php"><i class="fa fa-bars"></i> <span>Add Course</span></a></li>
                                           ...
                                           <li><a href="manage-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Manage Course Combination </span></a></li>
                                        </ul>
                                    </li>
                                    <li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Semester</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="create-class.php"><i class="fa fa-bars"></i> <span>Add Semester</span></a></li>
									   ...
									   <li class="has-children">
                                        <a href="#"><i class="fa fa-users"></i> <span>Exam</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="new-exam.php"><i class="fa fa-bars"></i> <span>New Exam</span></a></li>
											
                                            <li><a href="manage-exam.php"><i class="fa fa fa-server"></i> <span>Add Students</span></a></li>
