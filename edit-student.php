...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update student set examRoll=:examRoll,Name=:stname,Gender=:gender,Session=:session,DOB=:dob,Status=:status where classRoll=:stid ";
...
<div class="col-sm-10">
<input type="text" name="classRoll" class="form-control" id="classRoll" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="examRoll" class="form-control" id="examRoll" maxlength="5" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="stname" class="form-control" id="stname" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="session" class="form-control" id="session" required="required" autocomplete="off">
</div>
</div>
