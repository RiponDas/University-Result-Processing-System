                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>University Result Processing System</h4>
                                </div>
                            </div>
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="rollid">Exam Roll</label>
                                        <input type="text" class="form-control" id="rollid" placeholder="Enter Your Exam Roll" autocomplete="off" name="rollid">
                                	</div>
                               <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Exam</label>
 <select name="exam" class="form-control" id="default" required="required">
<option value="">Select Exam</option>
<?php $sql = "SELECT distinct SubjectName from tblsexamsemester";
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>Copyright © <a href="#">CSEBU</a> 2017</small></p>
                    </div>
